...
$echo[] = "<label for=ddc><b>Explain DDC;</b> </label><br> <input tabindex=3 id=ddc name=ddcflag type=checkbox $c><p>";
$echo[] = "<label for=rnum><b>Record number</b>; starts with 0</label><br><input  tabindex=4 id=rnum data-type=n  name=recnum type=text value='$param->recnum' size=5 maxlength=256><br>";
$echo[] = "<label for=rpp><b>Records per page</b>:</label><br><input  tabindex=5  id=rpp data-type=n  name=rpv type=text value='$param->rpv' size=2 maxlength=2><br>&nbsp;";
